...
AZURE_RESOURCE_MAP = {
    ...
    "region": "eastus2",
    "resources": {
        "sql_server": "salespoc-sql",
        "sql_database": "salespoc-db",
        "cosmos_account": "salespoc-cosmos",
        "storage_account": "salespocstore",
        "api_app_service": "salespoc-api",
        "apim_service": "salespoc-apim",
        "ai_foundry": "salespoc-ai-foundry",
        "static_web_app": "salespoc-ui",
